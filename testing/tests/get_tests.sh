...
curl -i -H "Connection: close" -H "Cookie: session_id=$session_id" http://localhost:15000/ > results/get/get1.txt &
echo -e "\n"
...
curl -i -H "Connection: close" -H "Host: server3" -H "Cookie: session_id=$session_id" http://localhost:15000/test.pdf > results/get/get2.txt &
echo -e "\n"
...
curl -i -H "Connection: close" -H "Host: server2" -H "Cookie: session_id=$session_id" http://localhost:15001/main.js > results/get/get3.txt &
echo -e "\n"
...
curl -i -H "Connection: close" -H "Host: server2" -H "Cookie: session_id=$session_id" http://localhost:15001/catalog.xml > results/get/get4.txt &
echo -e "\n"
