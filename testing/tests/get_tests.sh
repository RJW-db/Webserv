...
curl -i http://localhost:15000/ > results/get/get1.txt &
echo -e "\n"
...
curl -i -H "Host: server3" http://localhost:15000/test.pdf > results/get/get2.txt &
echo -e "\n"
...
curl -i -H "Host: server2" http://localhost:15001/main.js > results/get/get3.txt &
echo -e "\n"
...
curl -i -H "Host: server2" http://localhost:15001/catalog.xml > results/get/get4.txt &
echo -e "\n"
...
curl -i http://localhost:15000/nonexistent > results/get/get5.txt &
echo -e "\n"
